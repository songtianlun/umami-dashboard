...
export const translations = {
  en: {
    ...
    serverAliasPlaceholder: 'https://your-domain.com',
    serverAliasDescription: 'Optional: Use this domain for website links instead of server URL',
  ...
  zh: {
    ...
    serverAlias: '服务器别名',
    serverAliasPlaceholder: 'https://your-domain.com',
    serverAliasDescription: '可选：使用此域名作为网站链接地址，替代服务器地址',
