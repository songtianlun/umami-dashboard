...
export const translations = {
  en: {
    ...
    fetchingFromServer: 'Fetching latest statistics from server...',
    dataFetchSuccess: 'Successfully fetched data for {count} websites',
    dataFetchFailed: 'Data fetch failed',
    checkConfiguration: 'Please check configuration',
    networkConnectionFailed: 'Network connection failed, please check your network connection',
    ...
    configurationDescription: 'Configure your Umami server connection information. Configuration will be saved in your local browser.',
    connectionSettingsDescription: 'Please enter your Umami server address and login credentials',
    ...
    refreshIntervalDescription: 'Set the automatic refresh interval for panel data',
    selectRefreshInterval: 'Select refresh interval',
    refreshIntervalNote: 'Choose the automatic data refresh interval. Setting to "Disable" will turn off auto-refresh.',
    seconds: 'seconds',
    minute: 'minute',
    minutes: 'minutes',
    disable: 'Disable',
    ...
    connectionSuccessfulDescription: 'Umami server connection test successful',
    connectionSuccessDescription: 'Successfully connected to Umami server',
    ...
    saveFailedDescription: 'Unable to save configuration, please try again',
    configurationReset: 'Configuration Reset',
    configurationResetFromEnv: 'Original configuration has been read from environment variables',
    configurationResetEmpty: 'Environment variables not configured, all fields have been cleared',
    ...
    configureUmamiFirst: 'Please configure Umami connection first',
    selectWebsite: 'Select Website',
    selectWebsiteToTest: 'Select website to test',
    websiteIdManualInput: 'Website ID (Manual Input)',
